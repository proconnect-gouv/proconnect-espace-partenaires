...
| Email OTP                                       | eidas1-mfa      | L'accès à la messagerie et à l'identité sont réputés différents. La combinaison de ces deux facteurs, d'une même catégorie, permet a titre dérogatoire de fournir un niveau MFA faible. |
