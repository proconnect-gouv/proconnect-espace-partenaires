...
| Email OTP                                       | eidas1-mfa      | Techniquement deux catégories (connaissance + possession de la messagerie) : MFA faible. Mais si la messagerie est elle-même uniquement protégée par un mot de passe, sa compromission suffit à accéder au service. Le guide ANSSI (R36) note explicitement que la compromission d'une messagerie permet généralement d'accéder à tous les comptes associés. Plafond strict : `eidas1-mfa`. |
| SMS OTP (en deuxième facteur)                                         | eidas1-mfa      | Canal non sécurisé (interception SS7, SIM swapping) : pas un facteur cryptographiquement fort.                                                                                                                                                                                                                                                                                              |
