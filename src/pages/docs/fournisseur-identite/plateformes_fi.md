...
> [!NOTE]
> Si votre FI est hébergé sur le RIE, sa Discovery URL doit utiliser un domaine en `rie.gouv.fr` ou `ader.gouv.fr` pour être résolue par ProConnect. Consultez [la page dédiée](./resolution_discovery_url.md).
