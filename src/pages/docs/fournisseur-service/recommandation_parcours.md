...
| Votre service est réservé à un public spécifique           | Affichez un encadré explicatif avec les conditions d'accès. Voir [comment restreindre l'accès à votre service](./restriction_acces.md).       | ![Annuaire des Entreprises](/images/docs/screenshot-annuaire-entreprises.png)[Annuaire des Entreprises](https://annuaire-entreprises.data.gouv.fr/lp/agent-public) |
