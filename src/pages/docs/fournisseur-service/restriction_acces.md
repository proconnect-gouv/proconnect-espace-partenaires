...
La seule exception est pour les personnes travaillant pour une organisation privée : il est possible de restreindre l'accès à son application qu'aux seuls agents publics.
