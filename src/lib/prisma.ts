...
import { PrismaClient as PrismaClientProconnect, type OidcClient } from '../../prisma/generated_clients/db_proconnect'
...
export const prisma_espace = global.prisma_espace || 
...
export const prisma_proconnect = global.prisma_proconnect || 
