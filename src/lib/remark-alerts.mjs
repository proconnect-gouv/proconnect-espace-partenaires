...
export default function remarkAlerts() {
  ...
  return (tree) => {
    ...
    visit(tree, 'blockquote', (node, index, parent) => {
      ...
      if (!firstParagraph || firstParagraph.type !== 'paragraph' || firstParagraph.children.length === 0) return;
      ...
      // Clean the text
      firstParagraph.children[0].value = text.replace(/^\[\!(NOTE|TIP|IMPORTANT|WARNING|CAUTION)\]\s*/, '');
