...
export const docTree: SideMenuProps.Item[] = [
  {
    ...
    items: [
      ...
      { 
        ...
        linkProps: { href: "/docs/fournisseur-service/implementation_technique" }
      },
      { 
        text: "Recommandations parcours", 
        linkProps: { href: "/docs/fournisseur-service/recommandation_parcours" }
      },
      { 
      ...
      { 
        ...
        linkProps: { href: "/docs/fournisseur-service/connaitre-le-fi-utilise" }
      },
      { 
      ...
      { 
        ...
        linkProps: { href: "/docs/fournisseur-service/changement-agentconnect-proconnect-fs" }
      },
      { 
        text: "Glossaire", 
  ...
  },
  {
    ...
    items: [
      ...
      { 
        text: "LemonLDAP", 
        linkProps: { href: "/docs/fournisseur-identite/idp-configs/lemon-ldap" }
      },
      { 
        text: "Migration AgentConnect", 
        linkProps: { href: "/docs/fournisseur-identite/changement-agentconnect-proconnect-fi" }
      }
    ]
  },
  {
